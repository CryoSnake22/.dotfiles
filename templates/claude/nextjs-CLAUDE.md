...
5. **Browser testing** — use `browser_eval` to verify pages in a real browser, especially for hydration issues or client-side >ehavior. Prefer this over `curl` for page verification.
